...
export function logTerminalInfo(): void {
  ...
  console.log(
    `  tput colors:  ${caps.tputColors > 0 ? caps.tputColors : "(unavailable)"}`,
  );
  console.log("");
  ...
  if (process.env.POKEDEX_COLORS) {
    console.log(
      `  Override:     ${process.env.POKEDEX_COLORS} (via POKEDEX_COLORS env var)`,
    );
  }
  ...
  console.log(
    `  Truecolor:    \x1b[38;2;255;0;0mPure Red\x1b[0m \x1b[38;2;255;165;0mOrange\x1b[0m \x1b[38;2;0;255;0mGreen\x1b[0m`,
  );
  console.log("");
