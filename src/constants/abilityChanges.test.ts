...
describe("abilityChanges", () => {
  describe("POKEMON_ABILITY_CHANGES", () => {
    it("should contain Gengar ability change (Gen 6→7)", () => {
      const gengarChange = POKEMON_ABILITY_CHANGES.find(
        (c) => c.pokemonId === 94,
      );
  ...
  describe("applyHistoricalAbilityChanges()", () => {
    it("should replace Gengar Cursed Body with Levitate in Gen 6", () => {
      ...
      const result = applyHistoricalAbilityChanges(
        94,
        "gengar",
        currentAbilities,
        6,
    ...
    it("should not change abilities in Gen 7+ for Gengar", () => {
      ...
      const gen7 = applyHistoricalAbilityChanges(
        94,
        "gengar",
        currentAbilities,
        7,
      );
      const gen9 = applyHistoricalAbilityChanges(
        94,
        "gengar",
        currentAbilities,
        9,
